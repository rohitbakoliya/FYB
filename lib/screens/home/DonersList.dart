...
import 'package:auth/screens/home/showDonorDetails2.dart';
          ...
          return ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ExpansionTile(
                  title: Text(
                    snapshot.data.documents[widget.ind]['users'][index]['user']
                        .toUpperCase(),
                    style: TextStyle(
                        color: Colors.white,
                  ...
                  onExpansionChanged: (bool expending) =>
                      setState(() => this.isExpended = expending),
                  trailing: Icon(
                    Icons.keyboard_arrow_down,
                    color: isExpended ? Colors.teal : Colors.white,
                  ),
                  children: <Widget>[
                    ShowDonor2(snapshot.data.documents[widget.ind]['users'][index]['user']),
                    // ShowDonor(
                    ...
                    //         ind: widget.ind,
                    //         user: snapshot.data.documents[widget.ind]['users']
                    //             [index]['user'])
                    //     .getDonorDetails(),
                  ],
                );
